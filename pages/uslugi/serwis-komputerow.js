...
const subServices = [
  ...
  },
  {
    ...
    description: "Obniżamy temperatury i przywracamy pełną wydajność Twojego sprzętu.",
    link: "/uslugi/czyszczenie-komputerow",
  },
  // Tutaj możesz dodać kolejne pod-usługi w przyszłości
  // {
  //   title: "Modernizacja i Upgrade",
  //   description: "Zwiększamy moc Twojego komputera, wymieniając kluczowe podzespoły.",
  //   link: "/uslugi/modernizacja-komputerow",
  // },
];
